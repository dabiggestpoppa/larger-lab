...
- tested SHA `3d3f8836b07432a37e7ab119b3c6848c64e442be`
...
- authoritative test command `cd stress-suite && PYTHONIOENCODING=utf-8 python -m pytest tests -q` -> **collected 1000 / passed 1000 / skipped 0 / failed 0** (artifact `pytest` `002ec07a76af3e25`, python `3.11.9`)

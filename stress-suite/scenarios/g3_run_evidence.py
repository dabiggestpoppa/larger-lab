...
def build_receipt(sid: str) -> dict:
    ...
    return {
        ...
        "topology_status": (a["topology_execution_status"]
                             or ("REVIEW_TOPOLOGY_RECOMMENDED" if a["topology_decision"] else "NONE")),
        "evidence_obtained_from_executed_topology": a["evidence_obtained_from_executed_topology"],

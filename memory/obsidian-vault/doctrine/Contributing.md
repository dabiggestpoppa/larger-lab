...
├── memory/memory-bank/                  # Error database and solutions
...
4. **Read the memory bank:**
   - `memory/memory-bank/errors-and-solutions.md` — Known issues
   - `memory/memory-bank/error-db.json` — Error database
...
### Memory Sync
- `memory/memory-bank/errors-and-solutions.md` — Log errors and fixes
- `memory/memory-bank/error-db.json` — Structured error database
- `workspace-state.md` — Cross-agent state relay

### Error Handling
- Errors >2 attempts → log to `memory/memory-bank/error-db.json`

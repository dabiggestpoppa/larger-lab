"""Cost analysis — metals, crypto, indices."""
...
other_pairs = ['XAUUSD', 'XAGUSD', 'BTCUSD', 'ETHUSD', 'US500', 'DE30', 'FR40', 'HK50']

# Load existing forex results
...
print()
print('Total pairs: %d, errors: %d' % (len(results), len(errors)), flush=True)

# Save combined
combined_path = r'C:\Users\wifik\Desktop\projects\larger-lab\quant-lab\reports\cost_analysis_all.json'
with open(combined_path, 'w') as f:
    json.dump(results, f, indent=2, default=str)
print('Saved to:', combined_path, flush=True)

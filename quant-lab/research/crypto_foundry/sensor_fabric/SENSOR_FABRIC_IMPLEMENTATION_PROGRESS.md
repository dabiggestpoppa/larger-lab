...
| Current checkpoint | SENSOR-B4-I04R2-RATIFY: operator accepts I04R2/I04R1/I04 and authorizes I05 only. PASS_SENSOR_B4_I04R2_USABLE_PROVENANCE_SEALED = OPERATOR_ACCEPTED; PASS_SENSOR_B4_I04R1_PROVENANCE_INTEGRITY_SEALED = OPERATOR_ACCEPTED; PASS_SENSOR_B4_I04_ACQUISITION_MANIFEST_REPOSITORY = OPERATOR_ACCEPTED; T0A_EVIDENCE_PIPELINE_COMPLETE = TRUE. Test-count wording clarification: I04R2 storage 582 nodes = 582 passing storage tests (not 582 collected); 584 collected = 582 passed + 2 platform skips; full suite 1964 collected = 1961 passed + 3 skipped + 0 failed. Historical I04/I04R2 evidence untouched (chronology preserved). Authorized: SENSOR-B4-I05 RAW PROJECTION + LINEAGE ONLY. I06 NOT authorized. T0A_EVIDENCE_PIPELINE_COMPLETE=TRUE; T0B_STORAGE_IMPLEMENTED=FALSE; SOURCE_REVISION_REGISTRY_IMPLEMENTED=FALSE; DURABLE_RESUME_IMPLEMENTED=FALSE; next_checkpoint_authorized=FALSE; recommended next SENSOR-B4-I06 SOURCE REVISION / MUTATION REGISTRY — NOT authorized and NOT started | SENSOR-B4-I04 COMPLETE — ACQUISITION + MANIFEST REPOSITORY (proposed `PASS_SENSOR_B4_I04_ACQUISITION_MANIFEST_REPOSITORY`): durable EvidenceBlob metadata + AcquisitionRecord + append-only PartitionManifest catalog with transactional current pointer, partition lock and expected-current CAS; 58 tests; storage 490 nodes; full suite 1867 passed / 0 failed / 3 skipped; historical I04 evidence preserved (I04R1 does not rewrite it) |

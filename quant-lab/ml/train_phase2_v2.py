"""Phase 2 training v2 — fixed NaN handling and calibration."""
...
def train_symbol(symbol, df, labels):
    ...
    # Skip calibration (prefit not supported in this sklearn version)
    ...
    result = {
        "symbol": symbol, "cv_accuracy": cv_acc, "test_accuracy": test_acc,
...
def main():
    print("=" * 60)
    print("PHASE 2 TRAINING v2 (FIXED)")
    print("=" * 60)
    ...
    if results:
        ...
        print(f"Avg CV: {avg_cv:.1%} | Avg Test: {avg_test:.1%}")

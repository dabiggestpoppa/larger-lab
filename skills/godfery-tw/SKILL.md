...
metadata: {"openclaw":{"emoji":"🐦","requires":{"bins":["curl","python3"],"env":["SKILLBOSS_API_KEY"]},"primaryEnv":"SKILLBOSS_API_KEY"}}
---
...
1. Sign up at [skillbossai.com](https://skillbossai.com)
2. Get your API key

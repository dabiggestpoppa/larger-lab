...
hermes_ask(
    prompt="Schedule a daily cron job that emails me a summary of my inbox at 8am",
    session_id="claude-chat-2026-05-16"
)
```
...
2. URL: `<tunnel-url>/mcp`
3. Client ID/Secret: from `hermes-mcp mint-client`
4. Claude completes OAuth flow automatically

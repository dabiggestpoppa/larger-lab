...
**Target GitHub repo:** `https://github.com/OranAi-Ltd/oransim`

---

## Step 1: Create the GitHub remote

The live repo is hosted at **`https://github.com/OranAi-Ltd/oransim`** (OranAI GitHub org handle `OranAi-Ltd`). Early drafts of this doc referenced `oranai` as a placeholder before the org handle was finalized — if you see that in any archived file, treat it as historical.
...
git remote add origin https://github.com/OranAi-Ltd/oransim.git
git branch -M main
...
```bash
cd /root/projects/oransim
grep -rIl "OranAi-Ltd/oransim" . | xargs sed -i 's|OranAi-Ltd/oransim|YOUR_HANDLE/oransim|g'
...
Go to https://github.com/OranAi-Ltd/oransim/settings and set:
...
Then on GitHub:
1. Go to https://github.com/OranAi-Ltd/oransim/releases/new

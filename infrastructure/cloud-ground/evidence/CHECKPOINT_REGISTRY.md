...
| B1-LOCAL | **VERIFYING (repair; claim corrected)** | 793289c6 (superseded) | c2b2f515 (superseded) | 2399ec674c09 (CI failure) | FAILED_REQUIRES_REPAIR → see B1-LOCAL-READINESS-CORRECTION.md; repairs R3..R9 pushed; local static revalidated RUN 316637514bfa → LOCAL_STATIC_READY_CI_REQUIRED; authoritative CI re-triggered on 3fcc2c71, operator confirmation required |
...
- 2026-08-29 (repair) — Failed authoritative CI run `33256476708` (phase `doctor`, `wsl` FileNotFoundError; OCE_RUN_ID `2399ec674c09`; artifact `b1-local-ground-evidence-2399ec674c09`, ID 9715967318, SHA-256 `d9931acd…27fc`) preserved as truthful history in `B1-LOCAL-READINESS-CORRECTION.md`. Superseding review packet: `B1-LOCAL-REVIEW-PACKET-SUPERSEDING.md`.

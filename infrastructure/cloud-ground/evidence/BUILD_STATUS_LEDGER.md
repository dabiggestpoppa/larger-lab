...
| B1-LOCAL | Local Ground (active target) | **VERIFYING (repair)** | Premature READY claim corrected (see `B1-LOCAL-READINESS-CORRECTION.md`): CI failed at `doctor` (wsl probe) run `33256476708`; repairs in progress; no readiness claim until authoritative CI passes |

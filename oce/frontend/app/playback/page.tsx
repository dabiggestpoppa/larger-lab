      ...
      <div className="flex-1 p-4 overflow-y-auto">
        ...
        <div className="flex items-center justify-center gap-4 mb-6">
          ...
          <button
            ...
            className="w-12 h-12 flex items-center justify-center rounded bg-[var(--accent-primary)] text-white hover:opacity-80 transition-opacity text-lg"
          >
            {isPlaying ? "⏸" : "▶"}
          </button>
          <button
        ...
        <div className="p-4 bg-[var(--bg-secondary)] rounded-lg border border-[var(--border-subtle)]">
          ...
          <div className="flex justify-between mt-2">
            ...
            <span className="text-[10px] font-mono text-[var(--text-dim)]">00:30:00</span>
        ...
        <div className="mt-4 p-4 bg-[var(--bg-secondary)] rounded-lg border border-[var(--border-subtle)]">
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <p className="text-xs font-mono text-[var(--text-primary)]">{isPlaying ? "Playing" : "Paused"}</p>
            </div>
            <div>
              <span className="text-[10px] font-mono text-[var(--text-muted)]">Speed</span>
            ...
            <div>
              ...
              <p className="text-xs font-mono text-[var(--text-primary)]">{((currentTime / totalDuration) * 100).toFixed(1)}%</p>
            </div>
          </div>
        </div>
      </div>

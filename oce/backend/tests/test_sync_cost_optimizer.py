...
def reset_sync_cost(tmp_path):
    ...
    from oce.backend.sync_cost_optimizer import SyncCostOptimizer
    import oce.backend.sync_cost_optimizer as sync_cost_optimizer
...
class TestSyncCostOptimizerInit:
    def test_singleton_identity(self):
        from oce.backend.sync_cost_optimizer import get_sync_cost_optimizer

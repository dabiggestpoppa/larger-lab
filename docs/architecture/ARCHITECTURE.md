...
| `memory/obsidian-vault/` | The Obsidian vault directory |
...
- Any error that takes >2 attempts to fix → logged to `memory/memory-bank/error-db.json`
- Error patterns → compressed into `memory/memory-bank/errors-and-solutions.md`
...
- Error patterns log to `memory/memory-bank/error-db.json`
...
- Writes structured markdown to `memory/obsidian-vault/` directory
